...
const renameFolderController = async (
...
const getUserFoldersController = async (
  req: Request<UserId, {}, {}>,
  res: Response
): Promise<void> => {
  const { userId } = req.params;
...
const getUnfolderedSourcesController = async (
...
const addSourceIntoFolderController = async (
...
const deleteSourceFromFolderController = async (
...
const addUserSourceController = async (
...
const addUserPodcastController = async (
  ...
  try {
    ...
    console.log(
      `Added new podcast "${podcastTitle}" for User=${userId} with ${totalEpisodes} episodes`
    );
  } catch (error: any) {
...
const userFeedItemsController = async (
...
const getItemsByCategoryController = async (
...
const getSavedItemsByCategoryController = async (
  req: Request<UserId & { categoryName: string }, {}, {}, { feedType?: 'rss' | 'podcast' }>,
  res: Response
) => {
  const { userId, categoryName } = req.params;
...
const allUserSourcesController = async (
  req: Request<UserId, {}, {}>,
  res: Response
): Promise<void> => {
  const { userId } = req.params;
...
const allUserRSSSourcesController = async (
  req: Request<UserId, {}, {}>,
  res: Response
): Promise<void> => {
  const { userId } = req.params;
...
const allUserPodcastSourcesController = async (
  req: Request<UserId, {}, {}>,
  res: Response
): Promise<void> => {
  const { userId } = req.params;
...
const folderItemsController = async (
...
const markItemReadController = async (
...
const markSourceItemsReadController = async (
  ...
  try {
    const result = await markSourceItemsRead(numericUserId, numericSourceId);
...
const markUserFeedItemsReadController = async (
  req: Request<UserId, {}, {}, { feedType?: 'rss' | 'podcast' }>,
  res: Response
): Promise<void> => {
  const { userId } = req.params;
...
const markUserFolderItemsReadController = async (
  req: Request<FolderItem, {}, {}>,
  res: Response
): Promise<void> => {
  const { userId, folderId } = req.params;
...
const saveItemController = async (
...
const allSavedItemsController = async (
...
const sourcePriorityController = async (
  req: Request<UserId, {}, {}, { feedType?: 'rss' | 'podcast' }>,
  res: Response
): Promise<void> => {
  const { userId } = req.params;
...
export const updateSourcePrioritiesController = async (
  ...
  try {
    console.log(`Updating ${feedType} priorities for user:`, userId, 'sources:', sources);
...
const readItemsController = async (
  req: Request<UserId, {}, {}, { feedType?: 'rss' | 'podcast' }>,
  res: Response
): Promise<void> => {
  const { userId } = req.params;
...
export {
  ...
  addUserSourceController,
  addUserPodcastController,
  userFeedItemsController,
  folderItemsController,
  markItemReadController,
  saveItemController,
  markUserFeedItemsReadController,
  markUserFolderItemsReadController,
  addSourceIntoFolderController,
  removeUserSourceController,
  deleteSourceFromFolderController,
  deleteFolderController,
  allUserSourcesController,
  getUserFoldersController,
  allSavedItemsController,
  sourcePriorityController,
  readItemsController,
  presetSources,
  getItemsByCategoryController,
  getSavedItemsByCategoryController,
  allUserRSSSourcesController,
  allUserPodcastSourcesController,
  getUnfolderedSourcesController,
  markSourceItemsReadController,
};
